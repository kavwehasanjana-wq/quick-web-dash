...
const ClassSubjectDrillDown: React.FC = () => {
  ...
  const loadAttendance = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const params = { startDate, endDate, limit: 200, page: 1 };
      let res;
      if (selectedSubject) {
        res = await adminAttendanceApi.getSubjectAttendance(currentInstituteId, selectedClass, selectedSubject, params);
      } else {
